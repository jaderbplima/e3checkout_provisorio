...
function (_Component) {
  ...
  function Address() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "handleShipmentChange", function (shipment) {
      console.log(shipment.value);

      _this.setState({
        selectedShipment: shipment.value
      });
    });
    ...
    value: function render() {
      ...
      var shipmentOptionsList = this.state.shipmentOptions.map(function (shipment) {
        return react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Segment"], {
          onClick: _this2.handleShipmentChange(shipment),
          style: {
            cursor: "pointer"
          },
          __source: {
...
//# sourceMappingURL=checkout.js.c941127d02e38a81bbbf.hot-update.js.map